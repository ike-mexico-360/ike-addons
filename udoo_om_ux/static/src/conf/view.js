...
export const OM = {
    ...
    font_choices: [
        ...
        { label: 'Google Fonts: BVN Pro', value: 'Be+Vietnam+Pro:ital,wght@0,100%3B0,200%3B0,300%3B0,400%3B0,500%3B0,600%3B0,700%3B1,100%3B1,200%3B1,300%3B1,400%3B1,500%3B1,600%3B1,700&display=swap' },
        ...
        { label: 'Google Fonts: Dosis', value: 'Dosis:wght@200..700&display=swap' },
        { label: 'Google Fonts: Duru Sans', value: 'Duru+Sans:ital,wght@0,200..900%3B1,200..900&display=swap' },
        { label: 'Google Fonts: Encode Sans', value: 'Encode+Sans:wght@200..700&display=swap' },
        { label: 'Google Fonts: Encode Sans Semi Expanded', value: 'Encode+Sans+Semi+Expanded:wght@200%3B300%3B400%3B500%3B600%3B700&display=swap' },
        ...
        { label: 'Google Fonts: Sen', value: 'Sen:ital,wght@400..800&display=swap' },
        { label: 'Google Fonts: Source Sans 3', value: 'Source+Sans+3:ital,wght@0,200..700%3B1,200..700&display=swap' },
        ...
        { label: 'Google Fonts: Titillium Web', value: 'Titillium+Web:ital,wght@0,200%3B0,300%3B0,400%3B0,600%3B0,700%3B0,900%3B1,200%3B1,300%3B1,400%3B1,600%3B1,700&display=swap' },
...
export class OmuxConf extends Component {
    ...
    async sysOnInit() {
        const otopKeys = ['g_ips', 'g_brd', 'g_dsy', 'g_fty'];
