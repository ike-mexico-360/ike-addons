...
export class PurchaseOrderReviewsDetails extends Component {
    static template = "ike_event_purchase.PurchaseOrderReviewsDetails"
    ...
    async _loadOrderData() {
        console.log("ENTRANDO _loadOrderData");
        ...
        try {
            ...
            console.log("RESPUESTA ORDER DATA:", orderData);

            if (orderData) {
                this.state.order_data = orderData;
            }
        } catch (e) {
            console.error("ERROR _loadOrderData:", e);

            this.notification.add(
                _t("Error loading order data: ") + e.message,
                {
                    type: "danger",
                    sticky: true,
                }
...
registry.category("public_components").add("ike_event_purchase.purchase_order_reviews_details", PurchaseOrderReviewsDetails);