...
class IkeEvent(models.Model):
    ...
    def _ike_event_send_whatsapp_notification(self, stage_ref):
        ...
        # Cambios 2026.09.09 Solicitude de cambio, se envía al estar en asistencia concluida -closed' -> 'completed'
